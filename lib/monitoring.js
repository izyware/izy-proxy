...
module.exports = (function() {
  ...
  // consolidate with pkgdashboard/tab/xcast2/userinput/logview/api.js 
  // levels: trace(6), debug(5), info(4), warn(3), error(2), fatal(1)
  modtask.log = function(queryObject) {
    ...
    var line = '[' + modtask.fixLen(prefix + '@' + fullcontext.join('.'), 40) + '] ' + msg;
    try {
